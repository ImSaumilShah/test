...
//    public void loadGlideBannerImage(Context context, ImageView iv, String url) {
//        try {
//            Glide.with(context)
//                    .load(url)
//                    .fitCenter()
...
////                    .centerCrop()
//                    .placeholder(R.drawable.la_mega_placeholder)
//                    .crossFade()
//                    .into(iv);
//
//
...
//                    .diskCacheStrategy(DiskCacheStrategy.ALL)
////                    .centerCrop()
//                    .placeholder(R.drawable.los_artist_bg)
////                    .crossFade()
//                    .into(iv);
//
//
...
//        final String price="\\b\\d{1,3}(\\.\\d{2})?\\b";
    ...
    public String getMonthNane(String date) throws ParseException {
    ...
    public String getDateYear(String date) throws ParseException {
        Date d = new SimpleDateFormat("yyyy-mm-dd", Locale.ENGLISH).parse(date);
        Calendar cal = Calendar.getInstance();
        cal.setTime(d);
        String monthName = new SimpleDateFormat("d,yyyy").format(cal.getTime());
        return monthName;
    }
}

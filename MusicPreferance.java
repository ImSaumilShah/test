...
public class MusicPreferance {
    ...
    public static List<SongDetails> playlist = new ArrayList<SongDetails>();
    public static List<SongDetails> shuffledPlaylist = new ArrayList<SongDetails>();
    public static SongDetails playingSongDetail;

    public static SharedPreferences getPreferanse(Context context) {
        return context.getSharedPreferences(Const.PREFS_FILENAME, Activity.MODE_PRIVATE);
    }
    ...
    public static SongDetails getLastSong(Context context) {
        if (playingSongDetail == null) {
            ...
            Gson mGson = new Gson();
            playingSongDetail = mGson.fromJson(lastplaySong, SongDetails.class);
        }
...
//    public static List<SongData> getPlaylist(Context context) {
...
//    }
//
//    public static List<SongData> getPlaylist(Context context, String path) {
